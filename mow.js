    ...
    return declare("bgagame.mow", ebg.core.gamegui, {
        ...
        */
        setup: function (gamedatas) {
            ...
            this.theHerd.updateDisplay = function (from) { return _this.updateDisplay.apply(_this.theHerd, [from]); };
            this.theHerd.isAcrobatic = function (stockItemId) { return _this.isAcrobatic.apply(_this.theHerd, [stockItemId]); };
            this.createCards();
        ...
        */
        ...
        enableAllowedCards: function (allowedCardsIds) {
            var _this = this;
